...
# Time to create frame for Input Field

input_frame = Frame(win_calc, width=312, height=50, bd=0, highlightbackground="black", highlightcolor="black",
...
# Second frame For buttons , right bellow Input frame

btns_frame = Frame(win_calc, width=312, height=272.5, bg="grey")
